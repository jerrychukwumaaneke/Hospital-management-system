...
$password=md5($_POST['npass']);
    $query=mysqli_query($con,"select ID from doctors where  (Email='$docemail') && Password='$password' ");
    $ret=mysqli_fetch_array($query);
    if($ret>0){
      $_SESSION['login']=$ret['ID'];
     echo "<script type='text/javascript'> document.location ='admin/add-doctor.php'; </script>";
    }
    else{
	...
	<body class="login">
		<div class="row">
			<div class="main-login col-xs-10 col-xs-offset-1 col-sm-8 col-sm-offset-2 col-md-4 col-md-offset-4">
				...
				<a href="../../index.html">	<h2> JCTH | Doctor Login</h2></a>
				</div>
      ...
      <div class="main-login col-xs-10 col-xs-offset-1 col-sm-8 col-sm-offset-2 col-md-4 col-md-offset-4">
        ...
        <fieldset>
              ...
              <div>
                <br>
<span class="input-icon">
<input type="email" name="docemail" class="form-control" required="true" placeholder="email" autofocus="true"/>  
<i class="fa fa-user"></i></span>
</div>
<br>
        <div>
            <span class="input-icon">
        <input type="password" class="form-control" required="true" name="npass" placeholder="Password" />
        <i class="fa fa-lock"></i>
