...
$update="UPDATE doctors SET specilization='$doctorspecilization',doctorName='$docname',address='$docaddress',docFess='$docfess,contactno='$doccontact "
$update=mysqli_query($con,"insert into doctors(specilization,doctorName,address,docFees,contactno,docEmail,password) values('$docspecialization','$docname','$docaddress','$docfees','$doccontactno','$docemail','$password')");
