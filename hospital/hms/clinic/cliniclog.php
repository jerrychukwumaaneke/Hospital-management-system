...
if(isset($_POST['submit']))
  {
    ...
    $query=mysqli_query($con,"select ID from hclinic where  (email='$email') && password='$password' ");
    $ret=mysqli_fetch_array($query);
    if($ret>0){
      $_SESSION['vid']=$ret['ID'];
     echo "<script type='text/javascript'> document.location ='clinicboard.php'; </script>";
    }
    else{
...
<style type="text/css">
    body{ 
        background-image: url('../images/doctor2.jfif');      
  ...
  <body class="login">
    <div class="row">
      <div class="main-login col-xs-10 col-xs-offset-1 col-sm-8 col-sm-offset-2 col-md-4 col-md-offset-4">
        ...
        <a href="../index.html"><h2> JCTH | Clinic-Doctor Login</h2></a>
