...
if (mysqli_num_rows($query_run)>0) 
{
 ...
 $update="UPDATE tblmedicalhistory SET patientname='$pname',BloodPressure='$bp',BloodSugar='$bs',Weight='$weight',Temperature='$temp',Medicalpres='$pres' WHERE id='$id'";
    ...
    <script type="text/javascript">
    	...
    	window.open("http://localhost/hospital management system project/hospital/hms/clinic/clinicmng.php",
    		"_self");
    </script>	
    <?php
    }
...
<button><a href="clinicmng.php" style="text-decoration: none;">Back</a></button>
