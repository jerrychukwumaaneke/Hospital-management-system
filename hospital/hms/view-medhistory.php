...
if(isset($_POST['submit']))
  {
   ...
   $pres=$_POST['pres'];
      ...
      $query.=mysqli_query($con, "insert into tblmedicalhistory(PatientID,patientname,BloodPressure,BloodSugar,Weight,Temperature,MedicalPres)value('$vid','$pname','$bp','$bs','$weight','$temp','$pres')");
    if ($query) 
    	{
?>
...
<html lang="en">
	<head>
		<title>Clinic | Medical History</title>
...
<div class="row">
<div class="col-sm-8">
<h1 class="mainTitle">Clinic | Medical History</h1>
</div>
<ol class="breadcrumb">
<li>
<span>Clinic</span>
