				...
				<div class="main-content" >
					<div class="wrap-content container" id="container">
						...
						<section id="page-title">
							<div class="row">
								<div class="col-sm-8">
									<h1 class="mainTitle">User Details</h1>
																	</div>
								<ol class="breadcrumb">
									<li>
										<span>User</span>
						...
						<div class="container-fluid container-fullw bg-white">
									...
									<div class="row">
								<div class="col-md-12">
									<h5 class="over-title margin-bottom-15">User <span class="text-bold">Details</span></h5>
...
$cnt=1;
?>
  <a href="updatep.php?id=<?=$login;?>"   title="edit"><i  style="color: blue;">UPDATE YOUR DETAILS HERE</i></a>
  </div>
