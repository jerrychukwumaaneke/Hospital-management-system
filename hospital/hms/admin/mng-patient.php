...
<div class="row">
<div class="col-sm-8">
<h1 class="mainTitle">Admin | Manage Patient</h1>
</div>
<ol class="breadcrumb">
<li>
<span>Admin</span>
...
<td>
  <a href="view-medhistory.php?viewid=<?php echo $row['ID']; ?>" title="view"><i class="fa fa-eye" style="color: black;"></i></a>
  <a href="update.php?id=<?php echo $row['ID'];?>"   title="edit"><i class="fa fa-edit" style="color: blue;"></i></a>
...
<tr>
	<td><?php echo $cnt;?></td>
	<td><img src="../images/patients_images/<?= $tblpatient['profilpic'];?>" width="80" height="80"></td>
