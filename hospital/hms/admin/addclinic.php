...
$sql=mysqli_query($con,"insert into hclinic(profilpic,docname,address,fees,contact,email,password) values('$file_name','$docname','$docaddress','$docfees','$doccontactno','$docemail','$password')");
if($sql)
{
echo "<script>alert('Clinic-Doctor info added Successfully');</script>";
										...
										<div class="col-lg-8 col-md-12">
											<div class="panel panel-white">
												...
												<div class="panel-body">
													...
													<form action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" method="post" enctype="multipart/form-data" role="form"  name="adddoc" method="post" onSubmit="return valid();">
