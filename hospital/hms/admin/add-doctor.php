...
$sql=mysqli_query($con,"insert into doctors(profilpic,specilization,doctorName,address,docFees,contactno,docEmail,password) values('$file_name','$docspecialization','$docname','$docaddress','$docfees','$doccontactno','$docemail','$password')");
if($sql)
{
