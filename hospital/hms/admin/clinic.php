...
<html lang="en">
	<head>
		<title>Clinic |Patient Medical Condition</title>
...
<div class="row">
<div class="col-sm-8">
<h1 class="mainTitle">Clinic |Patient Medical Condition</h1>
</div>
<ol class="breadcrumb">
<li>
<span>Clinic</span>
...
<li class="active">
<span>Patient Medical Condition</span>
</li>
</ol>
</div>
</section>
...
<td><?php echo $cnt;?></td>
    ...
    <td>
    	<a href="clinicview.php?viewid=<?=$tblmedicalhistory['ID']; ?>" title="view"><i class="fa fa-eye" style="color: black;"></i></a>
  <a href="clinicupdate.php?id=<?=$tblmedicalhistory['ID']; ?>"   title="edit"><i class="fa fa-edit" style="color: blue;"></i></a>
  <a onclick="return confirm('Are you sure, you want to delete?')" href="deleteclinic.php?id=<?=$tblmedicalhistory['ID']; ?>"  title="delete" ><i class="fa fa-trash" style="color: red;"></i></a>
    </td>
</tr>
<?php 
$cnt=$cnt+1;
