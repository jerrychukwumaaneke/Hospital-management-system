...
?>
							...
							<a href="edit-doctor-specialization.php?id=<?php echo $row['id'];?>" tooltip-placement="top" tooltip="Edit"><i class="fa fa-edit"  title="edit"  style="color: blue;"></i></a>
													
	<a href="doctor-specilization.php?id=<?php echo $row['id']?>&del=delete" onClick="return confirm('Are you sure you want to delete?')" tooltip-placement="top" tooltip="Remove"><i class="fa fa-trash" title="delete" style="color: red;"></i></a>
												</div>
