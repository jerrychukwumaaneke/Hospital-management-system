	...
	<li>
				...
				<li>
								...
								<ul class="sub-menu">
									<li>
										<a href="clinicr.php">
											<span class="title"> Clinic Review </span>
										</a>
									</li>
									<li>
										<a href="clinic.php">
											<span class="title"> Manage Clinic Patient</span>
										</a>
									</li>
									<li>
										<a href="addclinic.php">
											<span class="title"> Add Clinic-Doctor</span>
										</a>
									</li>
									<li>
										<a href="manage-clinic.php">
											<span class="title"> Manage Clinic-Doctor</span>
										</a>
									</li>
