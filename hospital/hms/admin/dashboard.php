...
<div class="col-sm-4">
									<div class="panel panel-white no-radius text-center">
										<div class="panel-body">
											<span class="fa-stack fa-2x"> <i class="fa fa-square fa-stack-2x text-primary"></i> <i class="fa fa-smile-o fa-stack-1x fa-inverse"></i> </span>
											<h2 class="StepTitle">Clinic-doctors</h2>
											
											<p class="links cl-effect-1">
												<a href="manage-clinic.php">
<?php $result = mysqli_query($con,"SELECT * FROM hclinic ");
$num_rows = mysqli_num_rows($result);
{
?>
Total Patients :<?php echo htmlentities($num_rows);  
...
?>
								...
								<div class="col-sm-4">
									<div class="panel panel-white no-radius text-center">
										<div class="panel-body">
											<span class="fa-stack fa-2x"> <i class="fa fa-square fa-stack-2x text-primary"></i> <i class="fa fa-users fa-stack-1x fa-inverse"></i> </span>
											<h2 class="StepTitle">Clinic</h2>
										
											<p class="cl-effect-1">
												<a href="clinic.php">
												<?php $result1 = mysqli_query($con,"SELECT * FROM tblmedicalhistory ");
$num_rows1 = mysqli_num_rows($result1);
{
?>
											Total medical history :<?php echo htmlentities($num_rows1);  } ?>		
												</a>
