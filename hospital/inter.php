...
$dscrption=$_POST['description'];
 $query=mysqli_query($con,"select ID from tblcontactus where  (Email='$email') && mobileno='$mobileno' ");
      			...
      			<div class="company_address">
				     	<h2>Hospital Address  :</h2>
						    	<p>500 Lorem Ipsum Dolor Sit,</p>
						   		<p>22-56-2-9 Sit Amet, Los-Angeles,</p>
						   		<p>London</p>
				   		<p>Phone:(00) 222 666 444</p>
				   		<p>Fax: (000) 000 00 00 0</p>
				 	 	<p>Email: <span>jcth@mycompany.com</span></p>
